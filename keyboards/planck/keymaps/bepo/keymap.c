...
["Ctrl","Win","","Alt","Lower",{w:2},"","Raise","Left","RAlt","Shift","Ctrl / Enter"],

[{y:0.5},"$/#","F1","F2","F3","F4","F5","F6","F7","F8","F9","F10","DEL"],
...
[{y:0.5},"","Reset","Debug","","","","","","","","","Del"],
["","","","Audon","Audoff","AGnorm","AGswap","BÉPO","NUMERC","","",""],
...
[_BEPO] = {
  ...
  {KC_LCTL, KC_LGUI, _______, KC_LALT, LOWER , KC_SPC    , KC_SPC , RAISE, KC_RALT, _______, KC_RSFT, RCTL_T(KC_ENT)}
},
