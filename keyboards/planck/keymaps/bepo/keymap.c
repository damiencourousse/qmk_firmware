...
[_NUMERIC] = {
  ...
  {_______, KC_HOME, KC_PGUP, KC_UP  , KC_PGDN, _______, _______, BP_1   , BP_2   , BP_3   , BP_PLUS, LT_TAB },
  {_______, KC_END , KC_LEFT, KC_DOWN, KC_RGHT, _______, _______, BP_0   , BP_DOT , BP_COMM, BP_MINS, KC_ENT }
},
